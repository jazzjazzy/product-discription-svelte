...
import { GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET, FACEBOOK_CLIENT_ID, FACEBOOK_CLIENT_SECRET, DOMAIN } from "$env/static/private";
...
export const googleAuth = google(auth, {
	...
	redirectUri: `${DOMAIN}/login/google/callback`,
	scope: ['email', 'profile']
});
...
export const facebookAuth = facebook(auth, {
	...
	redirectUri: `${DOMAIN}/login/facebook/callback`,
