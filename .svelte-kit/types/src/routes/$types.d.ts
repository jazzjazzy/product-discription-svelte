...
type LayoutRouteId = RouteId | "/" | "/(app)/(auth)/forgotten" | "/(app)/(auth)/login" | "/(app)/(auth)/regisitor" | "/(app)/(payments)/checkout" | "/(app)/(payments)/checkout/complete" | "/(app)/(payments)/checkout/payment" | "/(app)/(payments)/pricing" | "/(app)/dashboard" | "/(app)/profile" | "/admin" | "/admin/history/[[id]]" | "/admin/pricing/[[id]]" | "/admin/session/[[id]]" | "/admin/user/[[id]]" | null
