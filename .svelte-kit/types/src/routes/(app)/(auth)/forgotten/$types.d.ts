...
type RouteParams = {  };
type RouteId = '/(app)/(auth)/forgotten';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(app)/(auth)/forgotten/+page.server.js').load>>>>>>;
