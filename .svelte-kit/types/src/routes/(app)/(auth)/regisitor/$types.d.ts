...
type RouteParams = {  };
type RouteId = '/(app)/(auth)/regisitor';
...
type ActionsExport = typeof import('../../../../../../../src/routes/(app)/(auth)/regisitor/+page.server.js').actions
export type SubmitFunction = Kit.SubmitFunction<Expand<ActionsSuccess<ActionsExport>>, Expand<ActionsFailure<ActionsExport>>>
export type ActionData = Expand<Kit.AwaitedActions<ActionsExport>> | null;
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(app)/(auth)/regisitor/+page.server.js').load>>>>>>;
