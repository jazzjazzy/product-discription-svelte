...
type RouteParams = {  };
type RouteId = '/(app)/(payments)/pricing';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(app)/(payments)/pricing/+page.server.js').load>>>>>>;
