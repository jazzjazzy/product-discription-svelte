...
type RouteParams = {  };
type RouteId = '/(app)/(payments)/checkout/complete';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../../../src/routes/(app)/(payments)/checkout/complete/+page.server.js').load>>>>>>;
