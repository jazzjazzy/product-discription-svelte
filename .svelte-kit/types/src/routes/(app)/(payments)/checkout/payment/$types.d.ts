...
type RouteParams = {  };
type RouteId = '/(app)/(payments)/checkout/payment';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../../../src/routes/(app)/(payments)/checkout/payment/+page.server.js').load>>>>>>;
