...
return {
	...
	_: {
		client: {"start":"_app/immutable/entry/start.902a6a37.js","app":"_app/immutable/entry/app.24bef349.js","imports":["_app/immutable/entry/start.902a6a37.js","_app/immutable/chunks/scheduler.f5bd93bf.js","_app/immutable/chunks/singletons.167206ef.js","_app/immutable/chunks/index.b26b719a.js","_app/immutable/chunks/paths.b13e4029.js","_app/immutable/chunks/parse.bee59afc.js","_app/immutable/entry/app.24bef349.js","_app/immutable/chunks/scheduler.f5bd93bf.js","_app/immutable/chunks/index.972eeafd.js"],"stylesheets":[],"fonts":[]},
		nodes: [
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/admin/history/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/admin/pricing/_server.ts.js'))
			},
			{
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/admin/users/_server.ts.js'))
			},
			{
				id: "/api/discriptor",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/discriptor/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/replicate/image/etsy/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/replicate/minigpt4/_server.ts.js'))
			},
			{
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/(app)/(auth)/login/facebook/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/(app)/(auth)/login/facebook/callback/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/(app)/(auth)/login/google/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/(app)/(auth)/login/google/callback/_server.ts.js'))
			},
			{
